...
<html>
    <head>
        ...
        <meta name="GEPES" content="Tekne, Karavan, Yat, Yatch, Caravan, Boat">
        <meta name="description" content="Lüks tekne ve karavan yapımı, 3D modelleme ve daha fazlasını keşfetmek için sayfamızı ziyaret edebilirsiniz.">
        <meta name="robots" content="noindex" />
        <link rel="shortcut icon" type="image/png" href="assets\images\icon.png"/>
        <title>GEPES Group</title>
        ...
        <link rel="stylesheet" href="assets/css/styles.min.css?h=d31b1afae3cb77353fbb882de8cd0e08">
        ...
        <link rel="stylesheet" href="assets\css\headvideo.css">
        <link rel="stylesheet" href="assets\css\projeler.css">
        <link rel="stylesheet" href="assets\css\bloc.css">
    ...
    <!-- Start: Navbar -->
    <nav class="navbar navbar-light navbar-expand-md sticky-top text-capitalize bg-inverse scrolling-navbar" id="main-navbar" style="background: #006b9c;height: 60px;">
        <div class="container"><a class="navbar-brand" href="#"><img id="brand-image" src="assets\images\logo.svg?h=b73ca19e722d87376896fd27255efe1a" style="filter: brightness(200%) contrast(200%) saturate(200%);"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1" style="color: rgba(255,255,255,0.55);background: #ffffff;"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbar" style="color: rgb(255,255,255);">
                <ul class="navbar-nav mr-auto w-100 justify-content-end">
                    <li class="nav-item"><a class="nav-link active" href="#">Anasayfa</a></li>
                    <li class="nav-item" style="color: rgb(201,215,228);"><a class="nav-link active" href="#projeler">Projeler</a></li>
                    <li class="nav-item" style="color: rgb(201,215,228);"><a class="nav-link active" href="#referanslarımız">Referanslarımız</a></li>
                    <li class="nav-item" style="color: rgb(201,215,228);"><a class="nav-link active" href="#carousel-t">Değerlendirme</a></li>
                    <li class="nav-item" style="color: rgb(201,215,228);"><a class="nav-link active" href="#contact">İletişim</a></li>
                </ul>
            </div>
        </div>
        <div class="dropdown" id="selector">
            <button class="dropbtn" onclick="showmenu()">TR/EN</button>
            <div class="dropdown-content">
              <a href="index_TR.html">TR <img src="https://cdn1.iconfinder.com/data/icons/international-circular-flags/512/turkey_national_country_flag-512.png"/></a>
              <a href="index_EN.html">EN <img src="https://cdn1.iconfinder.com/data/icons/flags-of-the-world-2/128/united-states-circle-256.png"/></a>
            </div>
          </div>
    </nav><!-- End:  Navbar -->

    <header class="HeadVideo"><!--Start: VideoPlayer-->
        <video autoplay muted loop>
            <source src="assets\Videos\video.mp4" type="video/mp4">
        </video>
        <div class="HeadVideoContent">
            <h1 id="HeadText">  </h1>
        </div>
    </header><!--End: VideoPlayer-->
	...
	<div class="row py-4">
		<div class="col-md-3 col-sm-6 pb-3 px-2 card-mobile">
			<div class="card shadow rounded-lg">
              <a href="#" class="card-body text-center">
                <p><i class="grey-text fas fa-ship fa-3x"></i></p>
					<h4 class="grey-text">Tekne</h4>
                <p></p>
              </a>
            </div>
		</div>
		<div class="col-md-3 col-sm-6 pb-3 px-2 card-mobile">
			<div class="card shadow rounded-lg">
              <a href="#" class="card-body text-center">
                <p><i class="grey-text fas fa-caravan fa-3x"></i></p>
					<h4 class="grey-text">Karavan</h4>
                <p></p>
              </a>
            </div>
		</div>
		<div class="col-md-3 col-sm-6 pb-3 px-2 card-mobile">
			<div class="card shadow rounded-lg">
              <a href="#" class="card-body text-center">
                <p><i class="grey-text fas fa-network-wired fa-3x"></i></p>
					<h4 class="grey-text">5 Eksen CNC</h4>
                
              </a>
            </div>
		</div>
		<div class="col-md-3 col-sm-4 pb-3 px-2 card-mobile">
			<div class="card shadow rounded-lg">
              <a href="#" class="card-body text-center">
                <p><i class="grey-text fas fa-file-contract fa-3x"></i></p>
					<h4 class="grey-text">İşbirliği</h4>
        ...
        <!-- Start: Projelerimiz -->
    <section id="projeler" class="Projelerimiz">
        <div class="container">
            <!-- Start: Giris -->
            <div class="intro">
                <h2 class="text-center">Projelerimiz</h2>
                <p class="text-center">Güncel Olarak Projelerimiz. </p>
            </div><!-- End: Giris -->
            <!-- Start: Projelerimiz -->
            <div class="row projeler">
                <div class="col-sm-6 col-md-4 item"><img class="img-fluid" src="assets\images\tekne.png?h=2ce14ccffed9db677708648866dc8fcf">
                    <h3 class="name">Lüks Tekne</h3>
                    <p class="description">Kendi zevkinize göre özel tasarım Tekneler.</p>
                </div>
                <div class="col-sm-6 col-md-4 item"><img class="img-fluid" src="assets\images\karavan.jpg?h=e41d3fb408aa43bf64e4fe4ebdc8335f">
                    <h3 class="name">Karavan</h3>
                    <p class="description">Kendi zevkinize göre özel tasarım Karavanlar.</p>
                </div>
                <div class="col-sm-6 col-md-4 item"><img class="img-fluid" src="assets\images\5eksenCNC2.png?h=e41d3fb408aa43bf64e4fe4ebdc8335f">
                    <h3 class="name">5 Eksen CNC</h3>
                    <p class="description">BÜYÜK ÖLÇÜ 5-EKSEN CNC KOMPOZİT ÜRETİMİ MODEL VE KALIPÇILIK.</p>
                </div>
            </div><!-- End: Projelerimiz -->
        </div>
    </section><!-- End: Projelerimiz -->



    ><!-- Start: Brands -->
    <div id="referanslarımız" class="brands"> <a  style="padding-top: 10px;background: #eef4f7;margin-bottom: 10px;"> 
        <h2>Referanslarımız</h2>
            <img src="assets\images\pinterest.png">
            <img src="assets\images\twitter.png">
        </a>
    </div><!-- End: Brands -->
...
<footer id="footer" class="footer-1">
    ...
    <h5 class="widget-title">Linkler<span></span></h5>
    <ul class="thumbnail-widget">
    <li>
    <div class="thumb-content"><a href="#.">Hakkımızda</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="#.">Vizyonumuz</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="#.">Kalite Politikalarımız</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="#.">Liderlik</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="#.">Yenilikler</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="#.">Blog</a></div>	
    </li>
    <li>
    <div class="thumb-content"><a href="#.">Iletisim</a></div>	
    </li>
    </ul>
    </div>
    </div>
    ...
    <div class="col-12 col-md-6">
        <h2 class="h4"><i class="fa fa-location-arrow"></i> Konum</h2>
        <div class="row">
            <div class="col-12">
                <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1q6N2dO-dV-Ux6XwzFkcvDpUeV38vJQax&ehbc=2E312F" width="600" height="300"></iframe>
            </div>
    </div>
    ...
    <p>Copyright GEPES Group © 2022</p>
    </div>
    <div class="teory">
        <p>Berkay Köksal</p>
    </div>
...
<!--   Created by Berkay ^Teory^ Köksal ! -->
<!--   Berkay ^Teory^ Köksal Tarafından Oluşturulmuştur ! -->
</html>